...
1. Получет пост из RSS
2. Вычисляет content_hash = хэш
3. Запрашивает БД: SELECT id FROM posts WHERE content_hash = ?
4. Если запись найдена, пост уже был отправлен - пропускает
